...
namespace interact_with_projectItems
{
    internal class Module1 : Module
    {
        ...
        public static string MapSelected = ""; //property to hold the Selected map in the MapViewComboBox
        ...
        public static Module1 Current
        {
            get
            {
                return _this ?? (_this = (Module1)FrameworkApplication.FindModule("interact_with_projectItems_Module"));
            }
        }
