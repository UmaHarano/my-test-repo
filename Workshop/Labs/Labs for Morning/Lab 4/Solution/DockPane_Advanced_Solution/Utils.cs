...
namespace DockPane_Advanced_Solution
{
  internal class Utils
  {
    ...
    internal static async void OpenAndActivateMap(string url)
    {
      ...
      // if returns null - it has never been opeend
      if (map == null)
      {
    ...
    /// <summary>
    /// utility function to retrieve an ICommand given a daml-id
    /// </summary>
    /// <param name="commandId">unique daml-id of command</param>
    /// <returns>the ICommand matching the daml-id; null if it cannot be found</returns>
