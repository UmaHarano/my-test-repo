...
{
    internal class ConstructionToolSolutionModule : Module
    {
        private static ConstructionToolSolutionModule _this = null;

        /// <summary>
        /// Retrieve the singleton instance to this module here
        /// </summary>
        public static ConstructionToolSolutionModule Current
        {
            get
            {
                return _this ?? (_this = (ConstructionToolSolutionModule)FrameworkApplication.FindModule("ConstructionToolSolution_Module"));
            }
        }
