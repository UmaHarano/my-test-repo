...
namespace NavigateCamera
{
  ...
  class CameraControlViewModel : CustomControl
  {
    ...
    private void ZoomIn()
    {
      MappingModule.ActiveMapView.ZoomInFixedAsync();
    }
    ...
    {
      MappingModule.ActiveMapView.ZoomOutFixedAsync();
    }

    /// <summary>
    /// Indicates if a zoom operation can be performed.
    /// </summary>
    private bool CanZoom() { return MappingModule.ActiveMapView != null; }
    ...
    public double HeadingValue
    {
      ...
      set
      {
        ...
        MapView activeMapView = MappingModule.ActiveMapView;
    ...
    private void PitchDown()
    {
      ...
      {
        Camera.Pitch -= 5;
        MappingModule.ActiveMapView.ZoomToAsync(Camera);
      }
    }
    ...
    /// </summary>
    private bool CanAdjustPitch() { return MappingModule.ActiveMapView != null && MappingModule.ActiveMapView.ViewMode != ViewMode.Map; }
